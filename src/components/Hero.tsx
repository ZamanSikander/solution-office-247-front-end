          ...
          <div className="space-y-8 scroll-reveal animate">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm lg:text-xl text-gray-900/70 leading-relaxed max-w-3xl mx-auto">
                Expert academic writing, cutting-edge front-end development, and
            ...
            <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gradient-premium">
                  24/7 Support
                </span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    <DialogTitle className="font-display text-gradient-premium">
                  ...
                  <div className="mt-2 grid grid-cols-1 gap-3">
                    <Link href="/portfolio/ecommerce" className="w-full">
                      <Button
                        variant="outline"
                    ...
                    <Link href="/portfolio/academic" className="w-full">
                      <Button
                        variant="outline"
                        className="w-full justify-between btn-outline-premium group"
                      >
            ...
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-sm md:text-3xl lg:text-4xl text-gray-900/70">
                  500+
                </div>
                <div className=" text-sm font-medium text-gradient-premium">
                  Projects Completed
                </div>
              </div>
              <div className="text-center">
                <div className="text-sm md:text-3xl text-gray-900/70 lg:text-4xl">
                  98%
                </div>
                <div className=" text-sm text-gradient-premium font-medium">
                  Success Rate
                </div>
              </div>
              <div className="text-center">
