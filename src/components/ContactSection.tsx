      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-slide-in-up">
          ...
          <p className="text-md lg:text-xl  text-muted-foreground max-w-3xl mx-auto">
            ...
            Reach out to us and let's discuss how we can bring your vision to
            life.
          </p>
          <div className="mt-8">
            <Link href="/contact">
              <Button className="btn-gradient px-6 py-6 text-base">
                Get a quote
              </Button>
            </Link>
          </div>
        ...
        <div className="animate-slide-in-up animate-delay-200 mt-12">
          ...
          <div className="mt-8 bg-gradient-primary rounded-2xl p-6 text-white text-center">
            ...
            <p className="text-white/90 mb-4">
              ...
              business hours, and within 6 hours during weekends and holidays.
            </p>
