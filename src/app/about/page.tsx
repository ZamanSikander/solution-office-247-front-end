  ...
  const assurances = [
    {
      ...
      description:
        "Confidential handling and secure collaboration on every engagement.",
    },
    {
      icon: Users,
      title: "Expert Team",
      description:
        "Specialists across research, engineering, and design to cover end‑to‑end needs.",
    },
    {
      icon: Award,
      title: "Quality First",
      description:
        "Rigorous reviews and standards ensure consistently excellent outcomes.",
    },
  ];
      ...
      <section className="relative pt-32 pb-16 bg-gradient-primary overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h1 className="text-xl md:text-4xl font-display font-bold mb-4">
              About Solution Office 24/7
            </h1>
            <p className="text-sm  text-center md:text-lg text-white/90">
              Your on‑demand partner for academic excellence and modern web
              experiences.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((s, idx) => (
              <div key={idx} className="glass-card rounded-2xl p-6 text-center">
                <div className="text-md md:text-xl font-bold mb-1">
                  {s.value}
                </div>
      ...
      <section className="py-12 md:m-11">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-8">
            <h2 className="text-lg md:text-2xl font-heading font-semibold">
              Why Clients Choose Us
            </h2>
            <p className="text-muted-foreground mt-2 text-sm md:text-lg">
              We combine academic rigor and modern engineering to deliver
              dependable outcomes fast.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
