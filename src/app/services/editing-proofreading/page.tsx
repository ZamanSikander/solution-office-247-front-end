  ...
  const process = [
    {
      step: " Initial Review",
      description:
        "We examine your document’s overall structure, tone, and writing quality to plan the editing strategy.",
    },
    {
      step: "Detailed Editing",
      description:
        "Our editors correct grammar, punctuation, sentence structure, and ensure academic clarity and consistency",
    },
    {
      step: " Proofreading & Final Check",
      description:
        "We conduct a final proofread to eliminate any remaining errors and deliver both clean and track-changed versions.",
    },
    {
      step: "Delivery & Support",
      description:
        "We deliver the polished document on time and provide continuous support for any questions or additional edits.",
    },
  ];
