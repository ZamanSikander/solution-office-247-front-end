...
const page = () => {
  ...
  const process = [
    {
      ...
      description:
        "We start by understanding your thesis or dissertation requirements, defining clear research objectives, and preparing a detailed outline supported by credible academic sources.",
    },
    {
      step: "Writing & Development",
      description:
        "Our experienced academic writers develop each chapter—from introduction to conclusion—with original content, proper citations, and a strong focus on research methodology and critical analysis.",
    },
    {
      step: "Review & Quality Check",
      description:
        "Your work undergoes multiple stages of editing, formatting, and plagiarism checks to ensure it meets academic guidelines and maintains the highest quality standards.",
    },
    {
      step: "Delivery & Support",
      description:
        "We deliver your completed thesis or dissertation within the agreed timeframe and offer continued support for revisions or questions until final approval.",
    },
  ];
  ...
  const testimonial = {
    ...
    content:
      "The research paper I received was exceptional. The depth of analysis and quality of sources exceeded my expectations. I received an A+ on my assignment!",
  };
