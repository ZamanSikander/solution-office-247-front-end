  ...
  const process = [
    {
      ...
      description:
        "We analyze your user flows and brand personality to define where animations can add the most value.",
    },
    {
      step: "Motion Planning",
      description:
        "We design motion blueprints for UI interactions, transitions, and micro-interactions with timing and easing.",
    },
    {
      step: "Implementation",
      description:
        "Using Framer Motion and Motion.dev, we integrate performant, fluid animations directly into your React project.",
    },
    {
      step: "Optimization & Delivery",
      description:
        "Animations are tested for smoothness, responsiveness, and accessibility before final deployment.",
    },
  ];
