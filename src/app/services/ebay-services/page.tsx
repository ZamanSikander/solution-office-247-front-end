  ...
  const process = [
    {
      step: "Store Audit",
      description:
        "We review your current store setup, listings, and performance metrics.",
    },
    {
      step: "Optimization ",
      description:
        "Improve listing SEO, titles, descriptions, and product images.",
    },
    {
      step: "Inventory Management",
      description:
        " Organize and manage bulk uploads, stock levels, and pricing.",
    },
    {
      step: "Monitoring & Support ",
      description:
        "Track results, send reports, and provide ongoing assistance.",
    },
  ];
