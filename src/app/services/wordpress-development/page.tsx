  ...
  const process = [
    {
      ...
      description:
        "We discuss your site goals, content structure, and desired features to craft a suitable WordPress architecture.",
    },
    {
      step: "Design & Development",
      description:
        "We design your layout or convert your Figma design into a custom WordPress theme with WooCommerce if needed.",
    },
    {
      step: "Testing & Optimization",
      description:
        "We test for functionality, security, speed, and responsiveness before launch.",
    },
    {
      step: "Launch & Training",
      description:
        "We deploy your site/store, provide basic training, and offer ongoing maintenance/support options.",
    },
  ];
