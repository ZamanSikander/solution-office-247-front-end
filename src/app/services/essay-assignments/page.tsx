  ...
  const process = [
    {
      ...
      description:
        "We understand your assignment brief, gather relevant sources, and prepare a solid outline that aligns with your academic goals.",
    },
    {
      step: "Writing & Development",
      description:
        "Our academic writers create original content with strong arguments, critical analysis, and proper referencing in your preferred style.",
    },
    {
      step: "Review & Quality Check",
      description:
        "We thoroughly proofread, edit, and run plagiarism checks to ensure your essay or assignment meets academic standards.",
    },
    {
      step: "Delivery & Support",
      description:
        "We deliver on time and stay available for revisions or clarification to ensure you’re 100% satisfied.",
    },
  ];
