        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-md lg:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto">
              ...
              terms govern your use of Solution Office 24/7 services.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <p className="text-neutral-600 leading-relaxed mb-4">
                ...
                provided by Solution Office 24/7 ("Company," "we," "our," or
                "us"). By accessing or using our services, you agree to be bound
                by these Terms.
              </p>
              <p className="text-neutral-600 leading-relaxed">
                Our services include academic writing, front-end development,
                eCommerce solutions, and related consulting services. These
                terms apply to all users, clients, and visitors of our website
                and services.
              </p>
            </div>
            ...
            <div className="mt-16 space-y-8">
              <div>
                <h3 className="text-xl font-display font-bold mb-4 text-neutral-800">
                  Service Delivery and Quality
                </h3>
                <p className="text-neutral-600 leading-relaxed mb-4">
                  We are committed to delivering high-quality services within
                  agreed timelines. However, service delivery may be affected by
                  factors beyond our control, including but not limited to
                  technical issues, third-party dependencies, or client feedback
                  delays.
                </p>
                <p className="text-neutral-600 leading-relaxed">
                  We provide revision opportunities for most services to ensure
                  your satisfaction. Specific revision policies vary by service
                  type and will be communicated during project initiation.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  We treat all client information and project details as
                  confidential. Our privacy practices are detailed in our
                  Privacy Policy, which is incorporated into these Terms by
                  reference.
                </p>
                <p className="text-neutral-600 leading-relaxed">
                  We implement appropriate security measures to protect your
                  information and maintain client confidentiality in accordance
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  Either party may terminate services with written notice. We
                  may suspend services for violations of these terms,
                  non-payment, or other reasonable causes.
                </p>
                <p className="text-neutral-600 leading-relaxed">
                  Upon termination, you remain responsible for payment of
                  completed services and any outstanding balances.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  We encourage open communication to resolve any issues or
                  concerns. If disputes cannot be resolved informally, they will
                  be subject to binding arbitration in accordance with
                  applicable laws.
                </p>
                <p className="text-neutral-600 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  ...
                  website. Your continued use of services after changes
                  constitutes acceptance of the new Terms.
                </p>
                <p className="text-neutral-600 leading-relaxed">
                  We will notify you of material changes via email or prominent
                  website notice. It is your responsibility to review these
                  Terms periodically.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-neutral-50 p-6 rounded-2xl">
                  <div className="space-y-2 text-neutral-700">
                    <p>
                      <strong>Email:</strong>solutionoffice247@gmail.com
                    </p>
                    <p>
                      <strong>Phone:</strong> +92-323-6180902
                    </p>
                    <p>
                      <strong>Address:</strong> Global Service Available
                    </p>
                    <p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button className="btn-premium text-lg">Contact Us</Button>
              </Link>
