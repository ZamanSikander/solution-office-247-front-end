        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm lg:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto">
              ...
              explore the best solutions for your business. Our experts are here
              to help you succeed.
            </p>
          </div>
        </div>
              ...
              {[
                {
                  ...
                  description:
                    "Get personalized solutions that fit your specific business needs and goals.",
                  icon: CheckCircle2,
                },
                {
                  title: "Clear Understanding",
                  description:
                    "Understand pricing, timelines, and deliverables upfront with no surprises.",
                  icon: Clock,
                },
                {
                  title: "No Obligation",
                  description:
                    "Just friendly, expert advice to help you make informed decisions.",
                  icon: MessageCircle,
                },
              ].map((reason, idx) => {
            ...
            <Card className="glass-card border-0">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground text-md mb-6">
                  You can still reach out to us for general inquiries or to
