          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <p className="text-neutral-600 leading-relaxed mb-4">
                Solution Office 24/7 ("we," "our," or "us") is committed to
                protecting your privacy. This Privacy Policy explains how we
                collect, use, disclose, and safeguard your information when you
                use our services, including our website and any related
                applications.
              </p>
            ...
            <div className="mt-16 space-y-8">
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  ...
                  information. You can also opt out of certain communications
                  and request data portability. To exercise these rights, please
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mb-4">
                  ...
                  analyze traffic, personalize content, and provide relevant
                  advertisements.
                </p>
                <p className="text-neutral-600 leading-relaxed">
