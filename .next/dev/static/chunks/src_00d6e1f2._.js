...
"[project]/src/lib/sanityClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useScrollToTop = ()=>{
    _s();
    const { pathname } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useLocation"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanityClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sanityClient.ts [app-client] (ecmascript)");
...
const BlogPost = ()=>{
    ...
    const { slug } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useParams"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogPost.useEffect": ()=>{
            setIsLoading(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanityClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].fetch(`*[_type == "post" && slug.current == $slug][0]{
          title,
          date,
          content
        }`, {
                ...
                "BlogPost.useEffect": (data)=>{
                    setPost(data);
                    setIsLoading(false);
                }
            }["BlogPost.useEffect"]).catch({
                "BlogPost.useEffect": (error)=>{
...
_s(BlogPost, "swidZEt2MGnZ3N4kvzFBuqR3QlM=", false, function() {
    return [
...
//# sourceMappingURL=src_00d6e1f2._.js.map